package com.mooc.boss.house.comment.service;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.TypeReference;
import com.google.common.base.Strings;
import com.mooc.boss.house.comment.common.BeanHelper;
import com.mooc.boss.house.comment.common.CommonConstants;
import com.mooc.boss.house.comment.dao.UserFeignService;
import com.mooc.boss.house.comment.mapper.CommentMapper;
...
public class CommentService {
    ...
    @Autowired
    private UserFeignService userFeignClient;
    ...
    public List<Comment> getHouseComments(long houseId, int size) {
        ...
        comments.forEach(comment -> {
            User user = userFeignClient.getUserDetailById(comment.getUserId()).getResult();
    ...
    public List<Comment> getBlogComments(Integer blogId, Integer size) {
        ...
        String json = null;//redisTemplate.opsForValue().get(key);
        List<Comment> lists = null;
        if (Strings.isNullOrEmpty(json)) {
