                    ...
                    <section id="sidebar">
                        ...
                        <aside>
                            <ul class="sidebar-navigation">
                                <li class="active"><a href="/accounts/profile"><i
                ...
                <div class="col-md-9 col-sm-10">
                    <section id="profile">
                        ...
                        <div class="account-profile">
                            <div class="row">
                                <form role="form" id="form-account-profile" method="post" enctype="multipart/form-data"
                                      action="/accounts/profileSubmit">
                                                ...
                                                <dd>
                                                    <div class="form-group">
                                                        <input type="text" class="form-control" id="form-account-name"
                                                               name="name" required value="${(loginUser.name)!}">
                                                    </div><!-- /.form-group --></dd>
                                        ...
                                        <section id="about-me">
                                            ...
                                            <div class="form-group">
                                                <textarea class="form-control" id="form-contact-agent-message" rows="5"
                                                          name="aboutme">${(loginUser.aboutme)!}</textarea>
                                            </div><!-- /.form-group -->
                                        </section>
                                        <section id="social">
                                            <div class="form-group clearfix">
                                                <button type="submit" class="btn pull-right btn-default"
                                                        id="account-submit">更新
                                                </button>
                                            </div><!-- /.form-group -->
                                        </section>
                                            ...
                                            <form role="form" id="form-account-password" method="post"
                                                ...
                                                <div class="form-group clearfix">
                                                    <button type="submit" class="btn btn-default"
                                                            id="form-account-password-submit">更新密码
                                                    </button>
                                                </div><!-- /.form-group -->
