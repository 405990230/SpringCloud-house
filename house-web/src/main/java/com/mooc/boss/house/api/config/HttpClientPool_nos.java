...
//@Configuration
public class HttpClientPool_nos {
    //@Autowired
    ...
    public HttpClient httpClient(){
        ...
        requestConfigBuilder.setSocketTimeout(httpPoolProperties.getSocketTimeout());
        requestConfigBuilder.setConnectTimeout(httpPoolProperties.getConnectTimeout());
